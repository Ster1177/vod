			...
			<div class="top-navigation">
				...
				<div class="drop-navigation drop-navigation">
				  <ul class="nav nav-sidebar">
					...
					<li><a href=",ovies.html" class="menu1"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Videos</a></li>
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						...
						<div class="video-grid">
							...
							<iframe src="<?php echo base_url();?>videos/test_x265.mp4" allowfullscreen></iframe>
							<!--<video controls>
